...
def main():
    ...
    # printing the operator parser tabl
    ...
    stack.append('$')
    # print(master)
    print("The given Productions  of the Grammars are: ", master_list)
    ...
    while flag:
        ...
        # checking  front of stack  is  'id'  and input string front at any situation  comes for comparison then it is error. 
